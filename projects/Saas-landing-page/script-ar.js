/**
 * CloudPilot Arabic RTL — script-ar.js
 * All interactions preserved from the English version.
 * RTL-specific adjustments: parallax X axis is inverted.
 */
...
/* =============================================================
   5. Scroll Animations with stagger
   ============================================================= */
...
/* =============================================================
   9. Floating Cards Parallax — X axis INVERTED for RTL
   In RTL the visual is on the LEFT, so mouse movement from
   right to left should move cards in the opposite X direction.
   ============================================================= */
  ...
  document.addEventListener('mousemove', (e) => {
    ...
    requestAnimationFrame(() => {
      ...
      cards.forEach((card, i) => {
        const factor = (i + 1) * 4;
        /* Negate dx so parallax feels natural in RTL layout */
...
/* =============================================================
   10. Dashboard Table Row Interaction
   ============================================================= */
...
/* =============================================================
   12. Stats Counter Animation on Scroll
   ============================================================= */
(function initStatsCounters() {
  const stats = qsa('.db-stat__value');
  if (!stats.length) return;

  const parseValue = (text) => parseFloat(text.replace(/[^0-9.]/g, '')) || 0;
