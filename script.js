const translations = {
  en: {
    ...
    capabilitiesLabel: '02 / Capabilities', servicesTitle: 'What I Build', serviceLanding: 'Landing Pages', serviceBusiness: 'Business Websites', serviceArabic: 'Arabic RTL Websites', serviceCorporate: 'Corporate Websites', servicePortfolio: 'Portfolio Websites', serviceInterfaces: 'Custom Web Interfaces',
    trustResponsive: 'Responsive Design', trustCode: 'Clean Code', trustFast: 'Fast Loading', trustCommunication: 'Clear Communication', trustLanguages: 'Arabic & English', trustBusiness: 'Business Focused',
    ...
    emailLabel: 'Email', connectLinkedIn: 'Connect on LinkedIn', viewGithub: 'View my GitHub', availability: 'Available for selected freelance projects', formNumber: 'INQUIRY / 01', formEyebrow: 'Project inquiry',
  ...
  ar: {
    ...
    capabilitiesLabel: '02 / الخدمات', servicesTitle: 'ما الذي أقدمه؟', serviceLanding: 'صفحات هبوط احترافية', serviceBusiness: 'مواقع شركات', serviceArabic: 'مواقع عربية RTL', serviceCorporate: 'مواقع مؤسسية', servicePortfolio: 'مواقع بورتفوليو', serviceInterfaces: 'واجهات ويب مخصصة',
    trustResponsive: 'تصميم متجاوب', trustCode: 'كود نظيف', trustFast: 'تحميل سريع', trustCommunication: 'تواصل واضح', trustLanguages: 'العربية والإنجليزية', trustBusiness: 'تركيز على الأعمال',
    ...
    emailLabel: 'البريد الإلكتروني', connectLinkedIn: 'تواصل معي عبر لينكدإن', viewGithub: 'استعرض أعمالي على GitHub', availability: 'متاح حالياً لمشاريع المواقع وصفحات الهبوط.', formNumber: 'طلب مشروع / 01', formEyebrow: 'تفاصيل المشروع',
...
if (heroGallery && !reduceMotion.matches && window.matchMedia('(pointer: fine)').matches) {
